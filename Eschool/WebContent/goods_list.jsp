...
<body>
	<div class="pd-20">
				...
				<% 
					if(request.getAttribute("List")!=null){
						...
						for(Goods goods:list){
							...
							out.print("<td><a href='GoodsServlet?type=delete&goods_id="+goods.getGoodsId()+"' onclick=\"if(confirm('确定删除吗?')==false)return false;\">删除</a></td>");
							out.print("</tr>");
						}
					}
				%>
		...
		<center>
			...
			%><a
				href="GoodsServlet?type=pages&currentpageno=<%=currentpageno + 1%>">下一页</a>
			<a href="GoodsServlet?type=pages&currentpageno=<%=pageCount%>">尾页</a>
			<%
				} else if (currentpageno > 1 && currentpageno < pageCount) {
			%>
			<a href="GoodsServlet?type=pages&currentpageno=1">首页</a> <a
				href="GoodsServlet?type=pages&currentpageno=<%=currentpageno - 1%>">上一页</a>
			<a
				href="GoodsServlet?type=pages&currentpageno=<%=currentpageno + 1%>">下一页</a>
			<a href="GoodsServlet?type=pages&currentpageno=<%=pageCount%>">尾页</a>
			<%

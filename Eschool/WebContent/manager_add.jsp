...
<body>
	<form action="ManagerServlet?type=add" method="post" class="form form-horizontal" enctype="multipart/form-data">
		<!-- Id -->
		<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span>账号：</label>
				<div class="formControls col-5">
					<input type="text" class="input-text" id="manager_id" name="manager_id" />
				</div>
				<div class="col-4">
					<span id="span1">&nbsp;&nbsp;*</span>
				</div>
		...
		<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="password" class="input-text" id="manager_pwd" name="manager_pwd" />
				</div>
				<div class="col-4">
					<span id="span3">&nbsp;&nbsp;*</span>
				</div>
		...
		<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="file" class="input-text" name="manager_pic" />
				</div>
				<div class="col-4"></div>
			</div>
